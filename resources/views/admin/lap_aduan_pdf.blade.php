...
<p class="auto-style2"><strong><span class="auto-style1">LAPORAN ADUAN</span></strong></p>
	...
	<tr>
        ...
        <tbody>
            ...
            <tr style="font-size:10px; font-family:Arial, Helvetica, sans-serif">
                ...
                <td class="auto-style5">{{$item->kustomer->nama}}</td>
                <td class="auto-style5"> {{$item->kustomer->alamat}}</td>
                <td class="auto-style5">{{$item->kustomer->telp}} </td>
                <td class="auto-style5">{{$item->kustomer->email}} </td>
                <td class="auto-style5">{{$item->jenis_aduan}}  </td>
                <td class="auto-style5"> {{$item->isi_aduan}}</td>
            </tr>
            @endforeach    
        </tbody>
</table>
